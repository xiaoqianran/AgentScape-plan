...
> **状态：历史里程碑计划。** 2026-08-27 起，产品拓扑和实施顺序改用 `../01-product-architecture-replan.md` 的 PA-0～PA-8；本文 M5“中央统一客户端/Connector”与“AgentScape 等待单一 Connector”的关键路径已废止。T0～T6 测试层级、风险、回滚和观测章节仍可作为执行参考。
